...
const [messages, setMessages] = useState(() => {
  const saved = localStorage.getItem("mindmate-chat");
      ...
      if (res.ok) {
        ...
        setMessages([
          ...updatedMessages,
          {
            role: "assistant",
            content:
              "Unable to connect to MindMate AI."
          }
        ]);
      }
    } catch {
...
const createNewChat = () => {
  ...
  localStorage.removeItem("mindmate-chat");
};
      ...
      <div className="sticky top-0 z-20 backdrop-blur-xl bg-white/70 border-b border-white/40">
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-slate-800 text-md sm:text-xl">
                MindMate AI
              </h2>
  ...
  "
>
  <FaPlus size={6} sm:size={12} className="sm:mb-1" />
  New Chat
</button>
  ...
  <div className="flex flex-col items-center justify-center py-16 text-center">
    ...
    <p className="mt-2 text-slate-500 max-w-md">
      Share your thoughts,
      emotions, or concerns and get personalized support.
    </p>
  </div>
)}
